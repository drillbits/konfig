...
func TestRunEndPointUrl(t *testing.T) {
	...
	want := "https://asia-northeast1-run.googleapis.com/apis/serving.knative.dev/v1/namespaces/hightowerlabs/services/env"
	got := runEndPointUrl()
...
func TestRunEndPointUrlDefaultRegion(t *testing.T) {
	...
	want := "https://us-central1-run.googleapis.com/apis/serving.knative.dev/v1/namespaces/hightowerlabs/services/env"
	got := runEndPointUrl()
